...
document.getElementById("clickMeBtn").addEventListener("click", async () => {
  const totalSupply = await _declarations_hello__WEBPACK_IMPORTED_MODULE_0__.hello.totalSupply();
  for (var i = 0; i < totalSupply; i++) {
    var nft = await _declarations_hello__WEBPACK_IMPORTED_MODULE_0__.hello.getTokenInfo(i);
